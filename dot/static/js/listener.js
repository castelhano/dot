/*
* FUNCAO LISTENER PARA EVENTOS DE TECLADO (keydown) DIVIDIDO EM 2 ETAPAS, PASSANDO PARA A PROXIMA ETAPA SOMENTE SE CORRESPONDENTE NAO LOCALIZADO 
* --
* @version 3.0
* @since   02/03/2022
* @release 31/01/2023
...
document.addEventListener('keydown', (e) => {
	...
	// 2) ETAPA
		...
		e.preventDefault();
		if(e.target.getAttribute('data-listener_js') == 'escape-tab'){return false;}
		try{
