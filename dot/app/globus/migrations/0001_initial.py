    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('E', 'Escalado'), ('F', 'Folga'), ('C', 'Compensacao'), ('R', 'Ferias'), ('A', 'Fora de Escala')], default='E', max_length=3)),
            ...
            options={
                'permissions': [('consultar_escala', 'Consultar escala pessoal'), ('localizar_escala', 'Consultar outras escalas'), ('parametrizar_escala', 'Pode parametrizar escala'), ('importar_escala', 'Pode importar escala')],
            },
        ),
        migrations.CreateModel(
            name='Viagem',
            fields=[
                ...
                ('sentido', models.CharField(blank=True, choices=[('', '-----'), ('1', 'Ida'), ('2', 'Volta')], default='', max_length=3)),
                ('inicio', models.TimeField(blank=True, null=True)),
                ('termino', models.TimeField(blank=True, null=True)),
