    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateField(default=datetime.datetime.today)),
                ('from_user', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='from_user', to='auth.user')),
                ('to_user', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='to_user', to='auth.user')),
            ],
        ),
    ]
