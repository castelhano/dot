...
urlpatterns = [
    ...
    path('core_issues',views.issues,name='core_issues'),
    path('core_issue_add',views.issue_add,name='core_issue_add'),
    path('core_issue_id/<int:id>',views.issue_id,name='core_issue_id'),
    path('core_issue_update/<int:id>',views.issue_update,name='core_issue_update'),
    path('core_issue_delete/<int:id>',views.issue_delete,name='core_issue_delete'),
