...
urlpatterns = [
    ...
    path('portaria_area_add',views.area_add,name='portaria_area_add'),
    path('portaria_area_id/<int:id>',views.area_id,name='portaria_area_id'),
    path('portaria_area_update/<int:id>',views.area_update,name='portaria_area_update'),
    path('portaria_area_delete/<int:id>/delete',views.area_delete,name='portaria_area_delete'),
    ...
    path('portaria_registro_delete',views.registro_delete,name='portaria_registro_delete'),
    path('portaria_get_visitante',views.get_visitante,name='portaria_get_visitante'),
    path('portaria_get_registro',views.get_registro,name='portaria_get_registro'),
