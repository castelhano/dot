...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': [('view_registro', 'Visualizar registro'), ('add_registro', 'Adicionar registro'), ('delete_registro', 'Excluir registro')],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detalhe', models.CharField(blank=True, max_length=200)),
                ('vaga', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='portaria.vaga')),
                ('veiculo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='portaria.veiculo')),
            ],
            options={
                'default_permissions': [],
            },
