# Generated by Django 4.0 on 2022-01-16 23:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('componentes', models.ManyToManyField(related_name='frotas', to='oficina.Componente')),
            ...
            options={
                'permissions': [('alterar_prefixo', 'Pode alterar prefixo'), ('vender_frota', 'Pode vender frota'), ('movimentar_em_massa', 'Pode movimentar em massa')],
            },
        ),
    ]
