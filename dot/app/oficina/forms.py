...
class FrotaForm(forms.ModelForm):
    class Meta:
        model = Frota
        fields = ['empresa','prefixo','placa','renavan','chassi','modelo','capacidade_tanque','catraca_inicial','media_ideal','categoria','carroceria','classificacao','ano_fabricacao','ano_modelo','inicio_operacao','km_inicial','componentes','detalhe']
