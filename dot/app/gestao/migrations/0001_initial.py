# Generated by Django 4.0.2 on 2022-04-03 02:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('D', 'Diretor'), ('G', 'Gestor'), ('S', 'Supervisor'), ('O', 'Operacional')], default='O', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('responsavel', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='plano_responsavel', to=settings.AUTH_USER_MODEL)),
                ('staff', models.ManyToManyField(related_name='plano_staff', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='diretriz',
